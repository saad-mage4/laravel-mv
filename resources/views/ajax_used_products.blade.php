        ...
        <div class="col-xl-4  col-sm-6">
            <div class="wsus__product_item">
                ...
                @endif --}}
                    ...
                    <a class="add_cart position-static mt-2"  href="tel:{{$Vendor->phone}}">Call</a>
                    <a class="add_cart position-static mt-2"  href="#!{{$Vendor->phone}}">Chat</a>
                </div>
            </div>
        </div>
        @endforeach
    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="wsus__product_item wsus__list_view">
                ...
                <div class="wsus__product_details">
                    <a class="wsus__category" href="{{ route('used_products',['category' => $product->category->slug]) }}">{{ $product->category->name }} </a>
                ...
                @endif --}}
                    ...
                    <ul class="wsus__single_pro_icon">
                        <li><a class="add_cart"  href="tel:{{$Vendor->phone}}">Call</a></li>
                    <li><a class="add_cart"  href="#!{{$Vendor->phone}}">Chat</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="wsus__pro_details_text">
                                    <a class="title" href="{{ route('product_used_detail', $product->slug) }}">{{ $product->name }}</a>
                                    ...
                                    <ul class="wsus__button_area">
                                        <li><button type="button" onclick="addToCartInProductModal('{{ $product->id }}')" class="<cart">{{__('user.add to cart')}}</button></li>
                                ...
                                <div class="wsus__pro_det_share d-none">
                                    <h5>{{__('user.share')}} :</h5>
                                    <ul class="d-flex">
                                        <li><a class="facebook" href="https://www.facebook.com/sharer/sharer.php?u={{ route('product_used_detail', $product->slug) }}&t={{ $product->name }}"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a class="twitter" href="https://twitter.com/share?text={{ $product->name }}&url={{ route('product_used_detail', $product->slug) }}"><i class="fab fa-twitter"></i></a></li>
                                        <li><a class="linkedin" href="https://www.linkedin.com/shareArticle?mini=true&url={{ route('product_used_detail', $product->slug) }}&title={{ $product->name }}"><i class="fab fa-linkedin"></i></a></li>
                                        <li><a class="pinterest" href="https://www.pinterest.com/pin/create/button/?description={{ $product->name }}&media=&url={{ route('product_used_detail', $product->slug) }}"><i class="fab fa-pinterest-p"></i></a></li>
                                    </ul>
                                </div>
                                </div>
                            </div>
