                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-xxl-12 col-md-12 mt-4 mt-md-0">
                                            <div class="wsus__pro_det_vendor_text">
                                                ...
                                                <p><span>{{__('user.Store Name')}}:</span> {{ $Vendor->shop_name }}</p>
                                                {{-- <p><span>{{__('user.Address')}}:</span> {{ $Vendor->address }} {{ $user->city ? ','.$user->city->name : '' }} {{ $user->city ? ','.$user->city->countryState->name : '' }} {{ $user->city ? ','.$user->city->countryState->country->name : '' }}</p> --}}
                                                <p><span>{{__('user.Phone')}}:</span> {{ $Vendor->phone }}</p>
                                                <p><span>{{__('user.mail')}}:</span> {{ $Vendor->email }}</p>
                                                <div class="d-flex gap-3">
                                                    <a href="{{ route('seller-detail',['shop_name' => $user->seller->slug]) }}" class="see_btn d-flex justify-content-center align-items-center">{{__('user.visit store')}}</a>

                                                <a href="{{ route('user.chat-with-seller', $user->seller->slug) }}" class="see_btn d-flex justify-content-center align-items-center">{{__('user.Chat with Seller')}}</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-12">
