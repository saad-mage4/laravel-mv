      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <a href="{{ route('seller.shipping.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> {{__('admin.Add New')}}</a>
            @if($admin_shipping_enabled == 1)
                <p>Shipping is fixed by Admin</p>
            @endif
            <div class="row mt-4">
                <div class="col">
                  <div class="card">
                            ...
                            <tbody>
                                @foreach ($shippings as $index => $shipping)
                                    <tr>
                                        ...
                                        <td>
                                        <a href="{{ route('seller.shipping.edit',$shipping->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                        @if($shipping->is_free != 1)
...
<script>
    function deleteData(id){
        $("#deleteForm").attr("action",'{{ url("seller/shipping/") }}'+"/"+id)
    }
    function changeProductTaxStatus(id){
        ...
        $.ajax({
            ...
            url:"{{url('/seller/shipping-status/')}}"+"/"+id,
