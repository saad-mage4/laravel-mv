                        ...
                        <table class="table table-striped" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th width="10%">{{__('admin.Default')}}</th>
                        ...
                        <form action="{{ route('admin.store-product-variant-item') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                @if ($variantItems->count() != 0)
                                    <div class="form-group col-12">
                                        <label>{{__('admin.Is Default ?')}} <span class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    ...
                                    @if ($variantItems->count() != 1)
                                        <div class="form-group col-12">
                                            <label>{{__('admin.Is Default ?')}} <span class="text-danger">*</span></label>
                                            <select name="is_default" class="form-control">
                                                <option {{ $variantItem->is_default == 0 ? 'selected' : '' }} value="0">{{__('admin.No')}}</option>
                                                <option {{ $variantItem->is_default == 1 ? 'selected' : '' }} value="1">{{__('admin.Yes')}}</option>
                                            </select>
                                        </div>
                                    @endif
