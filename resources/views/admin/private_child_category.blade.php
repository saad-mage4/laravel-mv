      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <a href="{{ route('admin.private_child_category.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> {{__('admin.Add New')}}</a>
            <div class="row mt-4">
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($childCategories as $index => $childCategory)
                                    <tr>
                                        ...
                                        <td>
                                        <a href="{{ route('admin.private_child_category.edit',$childCategory->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                        {{-- @php
                                            $isPopular = false;
...
<script>
    function deleteData(id){
        $("#deleteForm").attr("action",'{{ url("admin/private_child_category/") }}'+"/"+id)
    }
    function changeProductSubCategoryStatus(id){
        ...
        $.ajax({
            ...
            url:"{{url('/admin/private_child_category-status/')}}"+"/"+id,
