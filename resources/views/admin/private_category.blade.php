        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">Private Category</div>
            </div>
          </div>

          <div class="section-body">
            <a href="{{ route('admin.private_category.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> {{__('admin.Add New')}}</a>
            <div class="row mt-4">
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-striped" id="dataTable">
                            ...
                            <tbody>
                                @foreach ($categories as $index => $category)
                                    ...
                                    <td>
                                        <a href="{{ route('admin.private_category.edit',$category->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                        {{-- @php
                                            $isPopular = false;
...
<script>
    function deleteData(id){
        $("#deleteForm").attr("action",'{{ url("admin/private_category/") }}'+"/"+id)
    }
    function changeProductCategoryStatus(id){
        ...
        $.ajax({
            ...
            url:"{{url('/admin/private_category-status/')}}"+"/"+id,
